...
import com.androidrider.demokart.databinding.LayoutFeaturedProductBinding
...
class FeaturedProductAdapter(
    ...
    RecyclerView.Adapter<FeaturedProductAdapter.AddProductViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AddProductViewHolder {
        val binding = LayoutFeaturedProductBinding.inflate(LayoutInflater.from(context), parent, false)
    ...
    inner class AddProductViewHolder(val binding: LayoutFeaturedProductBinding) :
