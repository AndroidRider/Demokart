...
class BrandAdapter(val context: Context, val list: ArrayList<BrandModel>) : RecyclerView.Adapter<BrandAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

        val binding = RecycleBrandLayoutBinding.inflate(LayoutInflater.from(context), parent, false)
    ...
    inner class ViewHolder(val binding: RecycleBrandLayoutBinding) :
