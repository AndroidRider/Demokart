...
import com.androidrider.demokart.databinding.ActivityPaymentBinding
...
class PaymentActivity : AppCompatActivity(), PaymentResultListener {
    ...
    private fun paymentProcess() {
        ...
        val totalPrice= intent.getStringExtra("totalCost")
        ...
        try {
            Firebase.firestore.collection("Products")
                ...
                .addOnSuccessListener {
                    ...
                    val quantity = getQuantity(intent.getStringArrayListExtra("quantities"))

                    saveData( it.getString("productName"),
                        it.getString("productCoverImage"),
                        it.getString("productSp"), productId, totalPrice!! , quantity)
                }
    ...
    private fun getQuantity(quantityList: ArrayList<String>?): String {
        return quantityList?.let {if (it.isNotEmpty())
                it.removeAt(0)else "1" } ?: "1"
    }

    private fun saveData(productName: String?, coverImage: String?, price: String?, productId: String, totalPrice: String, quantity: String) {
        ...
        try {
            ...
            firestore.document(key).set(data)
                .addOnSuccessListener {
                    ...
                    createNotification(productName, totalPrice)
    ...
    private fun createNotification(productName: String, totalPrice: String) {
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            ...
            .setStyle(NotificationCompat.BigTextStyle().bigText("Your order $productName, Rs.$totalPrice has been successfully placed."))
